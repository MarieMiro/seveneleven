...
class MailFilterForm(forms.ModelForm):
    subscribed_rubrics = forms.ModelMultipleChoiceField(
        queryset=SubRubric.objects.all(),
        required=False,
        widget=forms.CheckboxSelectMultiple,
        label='Категории, по которым получать письма'
    )

    class Meta:
        model = AdvUser
        fields = ('subscribed_rubrics',)